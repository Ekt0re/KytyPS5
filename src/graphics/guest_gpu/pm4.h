...
// Private AGC registers omitted from the public ShRegOffset enum. Shader binaries can still
// include them in the ShRegister arrays submitted through SET_SH_REG_INDIRECT.
